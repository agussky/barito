...
## How to install (DEFAULT or BASIC USAGE)
	* git clone https://github.com/agussky/barito.git
	* cd barito
...
## For PC/Laptop ONLY:
	...
	* Download File on Github (https://github.com/agussky/barito.git)
	* Extract File barito and enter the folder
	* Right Click on Mouse, Then Select "Git Bash Here" (Make sure you are in the barito folder!!!)
